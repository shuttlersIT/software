    ...
    "definitions": {
        ...
        "models.SoftwareDepartmentMatch": {
            ...
            "properties": {
                ...
                "department_id": {
                    "description": "DepartmentID is the ID of the department receiving the software\nexample: 3",
                    "type": "integer"
                },
                "id": {
                    "description": "ID is the unique identifier of the department match\nexample: 1",
                    "type": "integer"
                },
                "software_id": {
                    "description": "SoftwareID is the ID of the software\nexample: 2",
                    "type": "integer"
                },
                "updated_at": {
                    "type": "string"
        ...
        "models.SoftwareOrganizationMatch": {
            ...
            "properties": {
                ...
                "id": {
                    "description": "ID is the unique identifier of the organization match\nexample: 1",
                    "type": "integer"
                },
                "software": {
                ...
                "software_id": {
                    "description": "SoftwareID is the ID of the software assigned to the entire organization\nexample: 2",
                    "type": "integer"
                },
                "updated_at": {
                    "type": "string"
        ...
        "models.SoftwareTeamMatch": {
            ...
            "properties": {
                ...
                "id": {
                    "description": "ID is the unique identifier of the team match\nexample: 1",
                    "type": "integer",
                    "example": 1
                },
                "software": {
                ...
                "team_id": {
                    "description": "TeamID is the ID of the team receiving the software\nexample: 3",
                    "type": "integer",
                    "example": 3
                },
                "updated_at": {
